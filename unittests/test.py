...
class Startup(TestCase):
    ...
    def test_fail_power_on_while_estop(self):
        """Test should fail because machine cannot be powered on while in estop. This should be skipped in mock"""
        if mock:
    ...
    def test_pass_home_axes(self):
        """Test should pass and home all axes. Should be skipped if already homed. Bug doesn't allow unhoming and homing in sim"""
        if homed:
